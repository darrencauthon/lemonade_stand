...
describe LemonadeStand::Day do
  ...
  it 'knows the cost of goods for the day' do
    day = LemonadeStand::Day.new
    assert_equal 5.50, day.cost_of_goods
  end

  it 'reports the weather forecast' do
    day = LemonadeStand::Day.new
    assert_equal 'sunny', day.forecast
  end

  it 'reports the weather' do
    day = LemonadeStand::Day.new
    assert_equal 'hot', day.weather_report
  end

  it 'reports the events' do
  end
